										...
										foreach ($apps as $key => $app) {
										 ...
										 ?>
												<tr class="app_row <?php echo $type_class;?>">
													...
													<td class="summa_usa">
														<input type="text" name="summa_usa" class="form-control" value="<?php echo !$app->type ?  round($app->weight*$app->rate,2) : $app->rate?> $"></td>
...
<script type="text/javascript">
	...
	var generate_app_row = function(n,type=0){
		...
		ntr += ntd_client+ntd_info+ntd_weight+ntd_rate+"<td class='summa_usa'><input name='summa_usa' class='form-control' type='text'/></td><td class='summa'></td>"+ntd_comment; //ntd_status
